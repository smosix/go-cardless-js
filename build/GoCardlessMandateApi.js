...
var GoCardlessMandateApi = /** @class */ (function () {
    ...
    GoCardlessMandateApi.prototype.find = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this.api.request("mandates/" + id)];
            });
        });
    };
    return GoCardlessMandateApi;
}());
exports.GoCardlessMandateApi = GoCardlessMandateApi;
